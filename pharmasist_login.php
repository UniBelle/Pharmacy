...
<body class="portal">
	...
	<p class="p23"><em>WELCOME TO PHARMASIST PORTAL LOGIN</em></p>
	<form name="login"  onsubmit="return(validate());" method="POST" action="pharmasist_login.php">
	<fieldset class="field">
	  <legend><img src="login.png" class="img_login"></legend>
	  <div>
	  <input type="text" placeholder="Username"  name="username"/><br/>
	   <input type="password" placeholder="***" name="password" /><br/>
	   <input type="submit" name="login" value="LOGIN" onclick="validate()"/></div>
	  </fieldset>
    </form>
	<br/><br/><br/><br/>
   <p class="copy" ><a href="index.html">Back To Homepage</a>|<a href="register_pharmacist.php">Sign Up Here</a></p>
   <hr>
...
$query="SELECT * FROM pharmacists WHERE Password = '$password' AND Username = '$username'";
...
else
{
	...
	else
	{
		...
		$_SESSION['user_position'] = "pharmacist";
	
		header("Location: pharmasist_page.php");
	}
